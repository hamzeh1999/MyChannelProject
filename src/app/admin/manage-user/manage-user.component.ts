...
userId:number=0;
  ...
  // @ViewChild('contentChart', { static: false }) el1!: ElementRef;
  ...
  ngOnInit(): void {
    ...
    // this.home.getNumOfRegisterUsers();
    ...
    userAge2:any,email2:any,password_2:any,addressUser2:any,roleId2:any) //i send the old course info
  {
    ...
    this.UpdateUserForm.controls['roleId'].setValue(roleId2);//the user can't chang the is because i didn't put it in the dialog
...
DateForm:FormGroup= new FormGroup({
  ...
  SearchingUser(){
    this.home.searchingNumberOfUserByDate(this.DateForm.value);
  }
